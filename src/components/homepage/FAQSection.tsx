      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-blue-50 rounded-lg p-8 mt-10 text-center border border-blue-100">
            <h3 className="text-lg font-semibold mb-3">מוכנים להתחיל להתכונן למבחן?</h3>
            <p className="text-gray-700 mb-6">
              הצטרפו למאות תלמידים שכבר מתאמנים איתנו לקראת מבחן אמיר/אמיר"ם – בצורה ממוקדת, גמישה ומעודכנת.
            </p>
