...
export const ReadingPassage = ({ 
  ...
  if (passageWithLines && passageWithLines.length > 0) {
    return (
      <div className="bg-slate-800/90 backdrop-blur-sm rounded-xl p-6 border border-slate-600/50 text-slate-100 max-h-[600px] flex flex-col shadow-2xl">
        {title && (
  ...
  return (
    <div className="bg-slate-800/90 backdrop-blur-sm rounded-xl p-8 border border-slate-600/50 text-center max-h-[600px] flex items-center justify-center shadow-2xl">
