...
export const questions51to100: Question[] = [
...

  {
    ...
    correctAnswer: 2,
    explanation: "The passage describes how the lack of benefits creates additional costs and financial insecurity.",
    topicId: 9,
    categoryId: 2,
    difficulty: 'hard',
    passageTitle: "The Rise of the Gig Economy",
    ...
    tips: "Read carefully about the costs and risks described in the passage."
  },

  {
    ...
    correctAnswer: 2,
    explanation: "The passage calls for 'finding a balance between the flexibility... and the security'",
    topicId: 9,
    categoryId: 2,
    difficulty: 'medium',
    passageTitle: "The Rise of the Gig Economy", 
    ...
    tips: "The phrase 'finding a balance' appears explicitly in the passage."
  }
];
